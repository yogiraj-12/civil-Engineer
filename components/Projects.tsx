...
const Projects: React.FC = () => {
  ...
  return (
    <section id="portfolio" ref={containerRef} className="bg-[#0a0a0a] py-24 md:py-32 px-6 relative z-10">
      <div className="max-w-[1920px] mx-auto">
        <div className="mb-16 md:mb-24 px-2 md:px-12">
            <h2 className="text-[12px] text-yellow-600 font-bold tracking-[0.3em] uppercase mb-4">Our Portfolio</h2>
            <p className="text-4xl md:text-7xl font-serif text-white leading-none">
        ...
        <div className="flex flex-col">
          {PROJECTS.map((project, index) => (
            ...
            >
              <div className="py-12 md:py-24 px-2 md:px-12 flex flex-col lg:flex-row gap-10 lg:items-center">
                
                {/* Meta Data */}
                <div className="lg:w-1/4 space-y-6 md:space-y-8">
                  ...
                  <div className="text-xs text-gray-400 space-y-1 font-mono flex flex-wrap gap-x-4 gap-y-1 md:block">
                ...
                <div className="lg:w-1/4">
                  <p className="text-base text-gray-400 leading-loose font-light border-l border-white/10 pl-6">
                    {project.description}
                  </p>
                ...
                {/* Image */}
                <div className="lg:w-1/2 overflow-hidden relative aspect-[16/9] md:aspect-[21/9] lg:aspect-auto lg:h-[400px] rounded-lg">
